...
CREATE TABLE `users` (
   ...
   `deletedAt` TIMESTAMP ON DELETE CURRENT_TIMESTAMP,
   PRIMARY KEY (`id`)
);
...
ALTER TABLE `product-user` ADD CONSTRAINT `FK_298218ef-b3e1-443f-a884-dcdec048a91f` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`)  ;

ALTER TABLE `product-user` ADD CONSTRAINT `FK_7d9c050e-4563-4108-8b3c-b564970046de` FOREIGN KEY (`product_id`) REFERENCES `products`(`id`)  ;
